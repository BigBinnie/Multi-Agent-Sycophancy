...
start_idx=0
end_idx=500  
experiment_name=$dataset/${solver}_r${round}/${solver_1}_${solver_2}_${solver_3}
...
solver.solvers.solver_a.model_type=$type_4 \
solver.solvers.solver_b.model_type=$type_4 \
solver.solvers.solver_c.model_type=$type_4 \
